package com.flyzebra.uvccamera.module.cache;
...
import com.flyzebra.uvccamera.utils.EncodeHelper;
...
public class BitmapDiskCache implements ICache<Bitmap> {
    ...
    private String getSavePath(Context context) {
        ...
        String savePath = str.getAbsolutePath() + File.separator + "flyzebra";
        return savePath;
    }
}
