package com.flyzebra.uvccamera.ui.adpater;
...
import com.flyzebra.uvccamera.module.cache.DoubleBitmapCache;
...
public class PhotoAdapater extends RecyclerView.Adapter<PhotoAdapater.ViewHolder> implements View.OnClickListener {
    ...
    public PhotoAdapater(Context context, List<String> list, RecyclerView recyclerView) {
        mContext = context;
        mList = list;
