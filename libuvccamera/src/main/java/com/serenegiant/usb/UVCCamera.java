...
public class UVCCamera {
	...
	public static final int DEFAULT_PREVIEW_WIDTH = 848;
...
//================================================================================
    	...
    	if (mNativePtr != 0) {
    		if ((mControlSupports == 0) || (mProcSupports == 0)) {
    	    	...
    	    	if (DEBUG) {
					...
					FlyLog.i("Brightness:min=%d,max=%d,def=%d", mBrightnessMin, mBrightnessMax, mBrightnessDef);
					FlyLog.i("Contrast:min=%d,max=%d,def=%d", mContrastMin, mContrastMax, mContrastDef);
					FlyLog.i("Sharpness:min=%d,max=%d,def=%d", mSharpnessMin, mSharpnessMax, mSharpnessDef);
					FlyLog.i("Gain:min=%d,max=%d,def=%d", mGainMin, mGainMax, mGainDef);
					FlyLog.i("Gamma:min=%d,max=%d,def=%d", mGammaMin, mGammaMax, mGammaDef);
					FlyLog.i("Saturation:min=%d,max=%d,def=%d", mSaturationMin, mSaturationMax, mSaturationDef);
					FlyLog.i("Hue:min=%d,max=%d,def=%d", mHueMin, mHueMax, mHueDef);
					FlyLog.i("Zoom:min=%d,max=%d,def=%d", mZoomMin, mZoomMax, mZoomDef);
					FlyLog.i("WhiteBlance:min=%d,max=%d,def=%d", mWhiteBlanceMin, mWhiteBlanceMax, mWhiteBlanceDef);
					FlyLog.i("Focus:min=%d,max=%d,def=%d", mFocusMin, mFocusMax, mFocusDef);
				}
			}
    	} else {
    		mControlSupports = mProcSupports = 0;
    ...
    public final native void nativeDestroy(final long id_camera);

    public final native int nativeConnect(long id_camera, int venderId, int productId, int fileDescriptor, int busNum, int devAddr, String usbfs);
    public static final native int nativeRelease(final long id_camera);

	public static final native int nativeSetStatusCallback(final long mNativePtr, final IStatusCallback callback);
	public static final native int nativeSetButtonCallback(final long mNativePtr, final IButtonCallback callback);

    public static final native int nativeSetPreviewSize(final long id_camera, final int width, final int height, final int min_fps, final int max_fps, final int mode, final float bandwidth);
    public static final native String nativeGetSupportedSize(final long id_camera);
    public static final native int nativeStartPreview(final long id_camera);
    public static final native int nativeStopPreview(final long id_camera);
    public static final native int nativeSetPreviewDisplay(final long id_camera, final Surface surface);
    public static final native int nativeSetFrameCallback(final long mNativePtr, final IFrameCallback callback, final int pixelFormat);
...
//**********************************************************************
    ...
    public static final native int nativeSetCaptureDisplay(final long id_camera, final Surface surface);

    public static final native long nativeGetCtrlSupports(final long id_camera);
    public static final native long nativeGetProcSupports(final long id_camera);

    public final native int nativeUpdateScanningModeLimit(final long id_camera);
    public static final native int nativeSetScanningMode(final long id_camera, final int scanning_mode);
    public static final native int nativeGetScanningMode(final long id_camera);

	public final native int nativeUpdateExposureModeLimit(final long id_camera);
    public static final native int nativeSetExposureMode(final long id_camera, final int exposureMode);
    public static final native int nativeGetExposureMode(final long id_camera);

	public final native int nativeUpdateExposurePriorityLimit(final long id_camera);
    public static final native int nativeSetExposurePriority(final long id_camera, final int priority);
    public static final native int nativeGetExposurePriority(final long id_camera);

	public final native int nativeUpdateExposureLimit(final long id_camera);
    public static final native int nativeSetExposure(final long id_camera, final int exposure);
    public static final native int nativeGetExposure(final long id_camera);

	public final native int nativeUpdateExposureRelLimit(final long id_camera);
    public static final native int nativeSetExposureRel(final long id_camera, final int exposure_rel);
    public static final native int nativeGetExposureRel(final long id_camera);

	public final native int nativeUpdateAutoFocusLimit(final long id_camera);
    public static final native int nativeSetAutoFocus(final long id_camera, final boolean autofocus);
    public static final native int nativeGetAutoFocus(final long id_camera);

    public final native int nativeUpdateFocusLimit(final long id_camera);
    public static final native int nativeSetFocus(final long id_camera, final int focus);
    public static final native int nativeGetFocus(final long id_camera);

    public final native int nativeUpdateFocusRelLimit(final long id_camera);
    public static final native int nativeSetFocusRel(final long id_camera, final int focus_rel);
    public static final native int nativeGetFocusRel(final long id_camera);

    public final native int nativeUpdateIrisLimit(final long id_camera);
    public static final native int nativeSetIris(final long id_camera, final int iris);
    public static final native int nativeGetIris(final long id_camera);

    public final native int nativeUpdateIrisRelLimit(final long id_camera);
    public static final native int nativeSetIrisRel(final long id_camera, final int iris_rel);
    public static final native int nativeGetIrisRel(final long id_camera);

    public final native int nativeUpdatePanLimit(final long id_camera);
    public static final native int nativeSetPan(final long id_camera, final int pan);
    public static final native int nativeGetPan(final long id_camera);

    public final native int nativeUpdatePanRelLimit(final long id_camera);
    public static final native int nativeSetPanRel(final long id_camera, final int pan_rel);
    public static final native int nativeGetPanRel(final long id_camera);

    public final native int nativeUpdateTiltLimit(final long id_camera);
    public static final native int nativeSetTilt(final long id_camera, final int tilt);
    public static final native int nativeGetTilt(final long id_camera);

    public final native int nativeUpdateTiltRelLimit(final long id_camera);
    public static final native int nativeSetTiltRel(final long id_camera, final int tilt_rel);
    public static final native int nativeGetTiltRel(final long id_camera);

    public final native int nativeUpdateRollLimit(final long id_camera);
    public static final native int nativeSetRoll(final long id_camera, final int roll);
    public static final native int nativeGetRoll(final long id_camera);

    public final native int nativeUpdateRollRelLimit(final long id_camera);
    public static final native int nativeSetRollRel(final long id_camera, final int roll_rel);
    public static final native int nativeGetRollRel(final long id_camera);

	public final native int nativeUpdateAutoWhiteBlanceLimit(final long id_camera);
    public static final native int nativeSetAutoWhiteBlance(final long id_camera, final boolean autoWhiteBlance);
    public static final native int nativeGetAutoWhiteBlance(final long id_camera);

    public final native int nativeUpdateAutoWhiteBlanceCompoLimit(final long id_camera);
    public static final native int nativeSetAutoWhiteBlanceCompo(final long id_camera, final boolean autoWhiteBlanceCompo);
    public static final native int nativeGetAutoWhiteBlanceCompo(final long id_camera);

	public final native int nativeUpdateWhiteBlanceLimit(final long id_camera);
    public static final native int nativeSetWhiteBlance(final long id_camera, final int whiteBlance);
    public static final native int nativeGetWhiteBlance(final long id_camera);

	public final native int nativeUpdateWhiteBlanceCompoLimit(final long id_camera);
    public static final native int nativeSetWhiteBlanceCompo(final long id_camera, final int whiteBlance_compo);
    public static final native int nativeGetWhiteBlanceCompo(final long id_camera);

	public final native int nativeUpdateBacklightCompLimit(final long id_camera);
    public static final native int nativeSetBacklightComp(final long id_camera, final int backlight_comp);
    public static final native int nativeGetBacklightComp(final long id_camera);

	public final native int nativeUpdateBrightnessLimit(final long id_camera);
    public static final native int nativeSetBrightness(final long id_camera, final int brightness);
    public static final native int nativeGetBrightness(final long id_camera);

    public final native int nativeUpdateContrastLimit(final long id_camera);
    public static final native int nativeSetContrast(final long id_camera, final int contrast);
    public static final native int nativeGetContrast(final long id_camera);

	public final native int nativeUpdateAutoContrastLimit(final long id_camera);
    public static final native int nativeSetAutoContrast(final long id_camera, final boolean autocontrast);
    public static final native int nativeGetAutoContrast(final long id_camera);

	public final native int nativeUpdateSharpnessLimit(final long id_camera);
    public static final native int nativeSetSharpness(final long id_camera, final int sharpness);
    public static final native int nativeGetSharpness(final long id_camera);

    public final native int nativeUpdateGainLimit(final long id_camera);
    public static final native int nativeSetGain(final long id_camera, final int gain);
    public static final native int nativeGetGain(final long id_camera);

    public final native int nativeUpdateGammaLimit(final long id_camera);
    public static final native int nativeSetGamma(final long id_camera, final int gamma);
    public static final native int nativeGetGamma(final long id_camera);

    public final native int nativeUpdateSaturationLimit(final long id_camera);
    public static final native int nativeSetSaturation(final long id_camera, final int saturation);
    public static final native int nativeGetSaturation(final long id_camera);

    public final native int nativeUpdateHueLimit(final long id_camera);
    public static final native int nativeSetHue(final long id_camera, final int hue);
    public static final native int nativeGetHue(final long id_camera);

	public final native int nativeUpdateAutoHueLimit(final long id_camera);
	public static final native int nativeSetAutoHue(final long id_camera, final boolean autohue);
	public static final native int nativeGetAutoHue(final long id_camera);

	public final native int nativeUpdatePowerlineFrequencyLimit(final long id_camera);
    public static final native int nativeSetPowerlineFrequency(final long id_camera, final int frequency);
    public static final native int nativeGetPowerlineFrequency(final long id_camera);

    public final native int nativeUpdateZoomLimit(final long id_camera);
    public static final native int nativeSetZoom(final long id_camera, final int zoom);
    public static final native int nativeGetZoom(final long id_camera);

    public final native int nativeUpdateZoomRelLimit(final long id_camera);
    public static final native int nativeSetZoomRel(final long id_camera, final int zoom_rel);
    public static final native int nativeGetZoomRel(final long id_camera);

    public final native int nativeUpdateDigitalMultiplierLimit(final long id_camera);
    public static final native int nativeSetDigitalMultiplier(final long id_camera, final int multiplier);
    public static final native int nativeGetDigitalMultiplier(final long id_camera);

	public final native int nativeUpdateDigitalMultiplierLimitLimit(final long id_camera);
    public static final native int nativeSetDigitalMultiplierLimit(final long id_camera, final int multiplier_limit);
    public static final native int nativeGetDigitalMultiplierLimit(final long id_camera);

	public final native int nativeUpdateAnalogVideoStandardLimit(final long id_camera);
    public static final native int nativeSetAnalogVideoStandard(final long id_camera, final int standard);
    public static final native int nativeGetAnalogVideoStandard(final long id_camera);

	public final native int nativeUpdateAnalogVideoLockStateLimit(final long id_camera);
    public static final native int nativeSetAnalogVideoLoackState(final long id_camera, final int state);
    public static final native int nativeGetAnalogVideoLoackState(final long id_camera);

	public final native int nativeUpdatePrivacyLimit(final long id_camera);
    public static final native int nativeSetPrivacy(final long id_camera, final boolean privacy);
    public static final native int nativeGetPrivacy(final long id_camera);
}
